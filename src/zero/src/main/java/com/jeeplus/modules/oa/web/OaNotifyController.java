...
public class OaNotifyController extends BaseController {
	 ...
	 * 首页通知模块
	 */
	@RequestMapping("/oanotifydata")
	public String getOaNotifyData(HttpServletRequest request, HttpServletResponse response) {
		...
		return "modules/sys/login/notify-module";
	}
