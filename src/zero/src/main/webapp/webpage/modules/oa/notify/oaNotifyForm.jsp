<%@ page import="com.jeeplus.modules.oa.entity.OaNotify" %>
...
<div class="row">
	...
	<div class="panel panel-primary">
		...
		<form:hidden path="id"/>
				...
				<c:if test="${oaNotify.handleUrl != null && !(empty oaNotify.handleUrl)}">
					<div class="form-group">
						<label class="col-sm-2 control-label">处理地址：</label>
						<div class="col-sm-10">
							<a href="
							<%
								String handleUrl = ((OaNotify)request.getAttribute("oaNotify")).getHandleUrl();

								if (handleUrl.startsWith("http")) {
									out.print(handleUrl);
								} else {
									String url = request.getContextPath() + handleUrl;
