		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
			  ...
			  <%--<tr>--%>
				  ...
				  <%--<td class="width-35">--%>
					  <%--<sys:gridselect url="${ctx}/personnel/plan/orgType/data" id="orgType" name="orgType.id" value="${office.orgType.id}" labelName="orgType.name" labelValue="${office.orgType.name}"--%>
		   ...
		   <tr><td  class="width-15" class="active"><label class="pull-right">部门职责:</label></td>
			   <td class="width-35"><form:textarea path="duty" htmlEscape="false" rows="3" maxlength="200" class="form-control"/></td></tr>
	      </tbody>
	      </table>
	</form:form>
</body>
