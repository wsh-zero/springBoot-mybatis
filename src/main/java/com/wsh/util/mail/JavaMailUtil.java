...
//        msg.setRecipient(MimeMessage.RecipientType.BCC, new InternetAddress(mailBean.getRecipientAddress()));
        ...
        // 读取本地文件
        DataHandler dh = new DataHandler(new FileDataSource("src\\om1.jpg"));
        // 将图片数据添加到"节点"
        ...
        text.setContent(mailBean.getContent() + "<br/><img src='cid:mailTestPic'/>", "text/html;charset=UTF-8");
        ...
        // 读取本地文件
        DataHandler dh2 = new DataHandler(new FileDataSource("src\\22.docx"));
        // 将附件数据添加到"节点"
